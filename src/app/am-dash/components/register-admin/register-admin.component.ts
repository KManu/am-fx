...
export class RegisterAdminComponent implements OnInit {
  ...
  initForm() {
    this.orgForm = this.formBuilder.group({
      ...
      license_number: ['', Validators.compose([
        Validators.required
      ])],
  ...
  submit() {
    ...
    this.orgService.createOrganisation(org)
      .then( next => {
      ...
      .then( next => {
        // sucess message
        this.toastr.success('The organisation and admin user were created successfully.', 'Creation Successful.');
      })
      .catch(error => {
        console.log(error);
        this.toastr.error('There was an error. Please check your internet connection and try again', 'Creation Failed.');
      });
  }
